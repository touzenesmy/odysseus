...
def _sqlite_is_memory(url: str) -> bool:
    ...
    return db == ":memory:" or "mode=memory" in url
...
if "sqlite" in DATABASE_URL and not _sqlite_is_memory(DATABASE_URL):
    ...
    def _enable_sqlite_concurrency(dbapi_connection, connection_record):
        ...
        # busy_timeout: writers queue up to 30 s instead of failing instantly
        # (default was 0 → instant "database is locked").
